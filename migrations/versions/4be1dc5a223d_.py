...
Revision ID: 4be1dc5a223d
Revises: 
Create Date: 2026-03-27 10:00:26.656366
...
def upgrade():
    ...
    sa.Column('delivered_before', sa.Float(), nullable=True),
    sa.Column('created_on', sa.DateTime(), nullable=True),
    ...
    sa.Column('received_items', sa.JSON(), nullable=True),
